			...
			<table class="table table-nomargin dataTable table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class='hidden-1024'>Strength T1</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        <?php      
                                        $i=1;
                                        $result = mysql_query("select * from student_report order by strength ASC limit 0,5");
                                        ...
                                        <tr>
                                            ...
                                            <td class='hidden-1024'><?php echo $row['strength']; ?></td>
                                        </tr>
                                        <?php
                                        $i++;
                                    }
