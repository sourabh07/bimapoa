...
<div class="box box-color box-bordered blue">
<div class="box-title">
<h3><i class="icon-table"></i> Member Details</h3>
...
<button class="btn btn-mini btn-warning pull-right"
	style="margin-right: 10px;"
	onclick="window.location.href = 'member_export_data.php'">Export CSV</button>

<button class="btn btn-mini btn-warning pull-right"
	style="margin-right: 10px;"
	onclick="window.location.href ='../download_log.php?sampleFile=uploads/log/log_members.txt'">Download
Log</button>
	<?php
}
else
...
<table
	...
	{
		$qrystring = "select * from bimapoa_members where selected_provider_code = '".$_SESSION['provider_code']."'";
	}
	...
	while ($row_member = mysql_fetch_array($result_member)) {
		...
		<tr <?php if($row_member['status']=='T'){ ?> style="color: red;"
		<?php }?>>
			<td class='hidden-350'><?php echo $i ?></td>
			<td class='hidden-1024'><?php echo $row_member['scheme'] ?></td>
			<td class='hidden-1024'><?php echo $row_member['policy_no'] ?></td>
			...
			<td class='hidden-1024'><?php echo $row_member['membership_no'] ?></td>
			<td class='hidden-1024'><?php echo $row_member['membership_name'] ?>
			</td>
			<td class='hidden-1024'><?php echo $row_member['dob'] ?></td>
			<td class='hidden-1024'><?php echo $row_member['sex'] ?></td>
			<td class='hidden-1024'><?php echo $row_member['relation'] ?></td>
			<td class='hidden-1024'><?php echo $row_member['national_id'] ?></td>
			...
			<td class='hidden-1024'><?php echo $row_member['chw_code'] ?></td>
			<td class='hidden-1024'><?php echo $row_member['date_signed'] ?></td>
			<td class='hidden-1024'><?php echo $row_member['date_captured'] ?></td>
			<td class='hidden-1024'><?php echo $row_member['card_issued'] ?></td>
			<td class='hidden-1024'><?php echo $row_member['status'] ?></td>
