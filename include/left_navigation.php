    ...
    ?>
        <div class="subnav">
            ...
            <ul class="subnav-menu">
                <li><a href="./user_management/manage_users.php">User Management</a>
                </li>
            </ul>
        </div>
    <?php
...
?>
    <div class="subnav">
        <div class="subnav-title">
            <a href="#" class='toggle-subnav'><i class="icon-angle-down"></i><span>Sales
                    Agent</span> </a>
        </div>
        <ul class="subnav-menu">
    ...
    <div class="subnav">
        <div class="subnav-title">
            <a href="#" class='toggle-subnav'><i class="icon-angle-down"></i><span>Providers</span>
            </a>
        </div>
        <ul class="subnav-menu">
            <li><a href="provider_management/manage_providers.php">Provider Management</a>
            </li>
        </ul>
    </div>
    <div class="subnav">
    ...
    <div class="subnav">
        <div class="subnav-title">
            <a href="#" class='toggle-subnav'><i class="icon-angle-down"></i><span>All
                    Transaction</span> </a>
        </div>
        <ul class="subnav-menu">
...
if ($user_type == "Admin") {
    ?>
        <div class="subnav">
            <div class="subnav-title">
                <a href="#" class='toggle-subnav'><i class="icon-angle-down"></i><span>Upload
                        Data</span> </a>
            </div>
            <ul class="subnav-menu">
                <li><a href="upload_data.php">CSV Upload</a>
                </li>
            </ul>
        </div>
    <?php
