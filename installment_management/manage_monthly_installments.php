	...
	<div id="main">
		<div class="container-fluid">
			<div class="page-header">
				<div class="pull-left">
					<h1> Manage Monthly Installments</h1>
				</div>
			...
			<div class="breadcrumbs">
				<ul>
					...
					<li><a href="#"> Manage Monthly Installments</a>
					</li>
				</ul>
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="box box-color box-bordered blue">
						<div class="box-title">
							<h3>
								<i class="icon-table"></i> Monthly Installments Details
							</h3>
                                                    
                                                    <button class="btn btn-mini btn-warning pull-right"
								style="margin-right: 10px;"
								onclick="window.location.href='export_monthly_payment_data.php'">Export CSV</button>
						</div>
...
<!--										<th class='hidden-450'>Action</th>-->
								...
								<tbody>
									...
									if(!empty($_POST['mpesa_transaction_date_from']) && !empty($_POST['mpesa_transaction_date_to']))
									{
										...
										$qrystring ="select * from monthly_payment where mpesa_transaction_date BETWEEN '".$from."' AND '".$to."'";
									...
									{
										$qrystring = "select * from monthly_payment  where policy_no='".$_POST['policy_no']."' or national_id='".$_POST['national_id']."'";
									}
									else if(isset($_POST['policy_no']) && $_POST['policy_no']!='')
									{
										$qrystring = "select * from monthly_payment where policy_no='".$_POST['policy_no']."'";
									}
									else if(isset($_POST['national_id']) &&  $_POST['national_id']!='')
									{
										$qrystring = "select * from monthly_payment where national_id='".$_POST['national_id']."'";
									}
									else
									{
										$qrystring = "select * from monthly_payment";
									}
									$qrystring = "select * from monthly_payment";
									}
									...
									<tr>  
										...
										<td class='hidden-1024'><?php echo $row_member['mpesa_transaction_amount']?></td>
