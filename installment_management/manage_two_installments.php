		...
		<div class="container-fluid">
			...
			<div class="breadcrumbs">
				<ul>
					...
					<li><a href="#"> Manage Two Installments</a>
					</li>
				</ul>
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="box box-color box-bordered blue">
						<div class="box-title">
							<h3>
								<i class="icon-table"></i> Two Installments Details
							</h3>
                                                    <button class="btn btn-mini btn-warning pull-right"
								style="margin-right: 10px;"
								onclick="window.location.href='export_two_installments_data.php'">Export CSV</button>
						</div>
...
<!--										<th class='hidden-450'>Action</th>-->
								...
								<tbody>
									...
									if(!empty($_POST['mpesa_transaction_date_from']) && !empty($_POST['mpesa_transaction_date_to']))
									{
										...
										$qrystring ="select * from two_time_payment where mpesa_transaction_date BETWEEN '".$from."' AND '".$to."'";
									...
									{
										$qrystring = "select * from two_time_payment  where policy_no='".$_POST['policy_no']."' or national_id='".$_POST['national_id']."'";
									}
									else if(isset($_POST['policy_no']) && $_POST['policy_no']!='')
									{
										$qrystring = "select * from two_time_payment where policy_no='".$_POST['policy_no']."'";
									}
									else if(isset($_POST['national_id']) &&  $_POST['national_id']!='')
									{
										$qrystring = "select * from two_time_payment where national_id='".$_POST['national_id']."'";
									}
									else
									{
										$qrystring = "select * from two_time_payment";
									}
									$qrystring = "select * from two_time_payment";
									}
