			...
			<table class="table table-nomargin dataTable table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class='hidden-1024'>Speed T2</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        <?php      
                                        $i=1;
                                        $result = mysql_query("select * from student_report order by speed2 ASC limit 0,5");
                                        ...
                                        <tr>
                                            ...
                                            <td class='hidden-1024'><?php echo $row['speed2']; ?></td>
                                        </tr>
                                        <?php
                                        $i++;
                                    }
