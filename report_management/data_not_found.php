		...
		<div class="container-fluid">
			...
			<div class="breadcrumbs">
				<ul>
					...
					<li><a href="#">Manage Pending Member Data</a>
					</li>
				</ul>
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="box box-color box-bordered blue">
						<div class="box-title">
							<h3>
								<i class="icon-table"></i> Pending Member Details
							</h3>
							...
							<table
								...
								<thead>
									<tr>
										...
										<th class='hidden-1024'>Transaction Code</th>
										<th class='hidden-1024'>Transaction Date</th>
										<th class='hidden-1024'>Amount Paid</th>
									</tr>
								</thead>
								<tbody>
									<?php 
									...
									while($row_member=mysql_fetch_array($result_mpesa))
									{
										...
										$count = $memberobj->row_count('bimapoa_members', "policy_no = '".$row_member['mpesa_account']."'");
										if($count ==  0)
										{
