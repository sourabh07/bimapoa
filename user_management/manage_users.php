			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="box box-color box-bordered blue">
						<div class="box-title">
							<h3>
								<i class="icon-table"></i> User Details
							</h3>
							...
							<table
								...
								<thead>
									<tr> 
										...
										<th class='hidden-1024'>Mobile No</th>
										<th class='hidden-1024'>Designation</th>
								...
								<tbody>
									...
									<tr> 
										...
										<td class='hidden-1024'><?php echo $row_user['user_email'] ?>
										</td>
										<td class='hidden-1024'><?php echo $row_user['password'] ?></td>
										<td class='hidden-1024'><?php echo $row_user['user_type'] ?></td>
										<td class='hidden-1024'><?php echo $row_user['role'] ?></td>
										<td class='hidden-1024'><?php echo $row_user['mobile'] ?></td>
										<td class='hidden-1024'><?php echo $row_user['designation'] ?>
										</td>
										<td class='hidden-1024'><?php echo $row_user['gender'] ?></td>
										...
										<td class='hidden-1024'><button
												class="btn btn-mini btn-warning"
												onclick="window.location.href = 'update_user_form.php?user_id=<?echo $row_user['user_id'];?>';">
												<i class="icon-edit"></i>
											</button>
                                                                                   <?php 
