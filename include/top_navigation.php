...
<div id="navigation">
<div class="container-fluid"><a href="dashboard.php" id="brand"> <!-- <img
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	class="icon-reorder"></i> </a> <?php if($user_type != "Provider")
	{
		?>
<ul class='main-nav'>
	...
	<ul class="dropdown-menu">
		...
		<li><a href="report_management/transaction_not_found.php">Pending
		Payment Data</a></li>
		<li><a href="report_management/pending_transaction_list.php">Pending
		Installments</a></li>
	</ul>
	</li>
</ul>
...
<div class="dropdown"><a href="#" class='dropdown-toggle'
	data-toggle="dropdown"><img src="img/logo.png" alt=""> </a>
<ul class="dropdown-menu pull-right">
	<li><a href="user_management/profile.php">Edit Profile</a></li>
	<li><a href="user_management/change_password.php">Change Password</a></li>
...
<a href="#" class='toggle-mobile'><i class="icon-reorder"></i> </a></div>
</div>
