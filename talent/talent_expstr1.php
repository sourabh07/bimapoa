			...
			<table class="table table-nomargin dataTable table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th class='hidden-1024'>Explosive Strength T1</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        <?php      
                                        $i=1;
                                        $result = mysql_query("select * from student_report order by exp_strength ASC limit 0,5");
                                        ...
                                        <tr>
                                            ...
                                            <td class='hidden-1024'><?php echo $row['exp_strength']; ?></td>
                                        </tr>
                                        <?php
                                        $i++;
                                    }
